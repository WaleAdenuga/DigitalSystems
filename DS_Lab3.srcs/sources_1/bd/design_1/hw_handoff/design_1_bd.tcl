...
proc create_root_design { parentCell } {
  ...
  set oBlue_0 [ create_bd_port -dir O -from 3 -to 0 oBlue_0 ]
  set oGreen_0 [ create_bd_port -dir O -from 3 -to 0 oGreen_0 ]
  set oHS_0 [ create_bd_port -dir O oHS_0 ]
  set oRed_0 [ create_bd_port -dir O -from 3 -to 0 oRed_0 ]
  set oVS_0 [ create_bd_port -dir O oVS_0 ]
  ...
  connect_bd_net -net VGA_pattern_0_oBlue [get_bd_ports oBlue_0] [get_bd_pins VGA_pattern_0/oBlue]
  connect_bd_net -net VGA_pattern_0_oGreen [get_bd_ports oGreen_0] [get_bd_pins VGA_pattern_0/oGreen]
  connect_bd_net -net VGA_pattern_0_oRed [get_bd_ports oRed_0] [get_bd_pins VGA_pattern_0/oRed]
  ...
  connect_bd_net -net VGA_timings_0_oHS [get_bd_ports oHS_0] [get_bd_pins VGA_timings_0/oHS]
  connect_bd_net -net VGA_timings_0_oVS [get_bd_ports oVS_0] [get_bd_pins VGA_timings_0/oVS]
  ...
  connect_bd_net -net reset_0_1 [get_bd_ports reset_0] [get_bd_pins VGA_timings_0/iRst] [get_bd_pins clk_wiz_0/reset]
